...
You can include $\LaTeX$ code both inline (between single dollar-signs) and in blocks (between double dollar-signs). For example, below is the equation for the probability density function of a normal distribution with mean $\mu$ and standard deviation $\sigma$.
